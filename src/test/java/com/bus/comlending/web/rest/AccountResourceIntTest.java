...
import com.bus.comlending.Myapp5App;
import com.bus.comlending.config.Constants;
import com.bus.comlending.domain.Authority;
import com.bus.comlending.domain.PersistentToken;
import com.bus.comlending.domain.User;
import com.bus.comlending.repository.AuthorityRepository;
...
import com.bus.comlending.security.AuthoritiesConstants;
...
import com.bus.comlending.web.rest.errors.ExceptionTranslator;
...
@SpringBootTest(classes = Myapp5App.class)
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, persistentTokenRepository,userOTPRepository);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, persistentTokenRepository,userOTPRepository);
